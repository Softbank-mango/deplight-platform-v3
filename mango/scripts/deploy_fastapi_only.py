...
def deploy_fastapi():
    ...
    deployment = {
        ...
        'analysis_id': analysis_id,
        'pusher': 'developer',
        'deployment_url': 'http://delightful-deploy-alb-796875577.ap-northeast-2.elb.amazonaws.com'
    }
    ...
    print()
    print("URL: http://delightful-deploy-alb-796875577.ap-northeast-2.elb.amazonaws.com/docs")
    print()
